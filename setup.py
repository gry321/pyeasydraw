...
setup(name='pyeasydraw',  # 包名 别人安装时就是用此名来按照 如：pip install pyutilitytool
      version='0.0.1',  # 包的版本号
      description='Python进行画画。',  # 包的介绍、概述
      author='郭若垚',  # 包的作者
      author_email='yao1127@aliyun',  # 邮箱
      url='https://github.com/Gry/pyeasydraw',  # 项目源代码地址 一般的填git地址
